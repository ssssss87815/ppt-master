...
export const PROJECT_STATUS_DESCRIPTIONS: Record<ProjectStatus, string> = {
  ...
  post_processing: 'Current-run final SVG post-processing is in progress or verified; PPTX export is not yet available.',
...
export const PROJECT_STATUS_ALLOWED_TRANSITIONS: Record<ProjectStatus, ProjectStatus[]> = {
  ...
  post_processing: ['failed_recoverable', 'failed_terminal'],
